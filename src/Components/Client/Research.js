...
const Research = () => {
  ...
  const handleSubmit = (event) => {
    ...
    // const winningProbability = getWinningProbability(problem); // Call your research function here
    setProbability(80);

  };  

  // Call your research function here to get the winning probability based on the problem.
  // Replace 'getWinningProbability' with your actual function.
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {probability !== null ? (
        <p>
          For the problem: <strong>{formData.title  }</strong>, the winning probability is: <strong>{probability}%</strong>
        </p>
      ) : (
        <></>
      )}
